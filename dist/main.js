...
.task-modal, .project-modal, .info-modal {
    ...
    function listenClicks() {
        ...
        document.addEventListener('click', e => {
            ...
            if (target.includes('fa-circle-info')) {
                _UI__WEBPACK_IMPORTED_MODULE_0__["default"].createInfo(e);
